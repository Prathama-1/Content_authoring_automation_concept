...
#     selectors = [".ups-breadcrumb.ups-component.on-top", ".ups-breadcrumb"]
#     breadcrumb = []
...
#             print("Breadcrumbs match exactly.")
#         else:
#             extra_live = live_texts - aem_texts
#             extra_aem = aem_texts - live_texts

#             print("Breadcrumbs do not match. Checking extra links...")
...
#             if invalids:
#                 print("Mismatch: Found invalid breadcrumb links:")
#                 for text, link in invalids:
#                     print(f" - '{text}' → {link}")
#             else:
#                 print("Breadcrumbs differ, but all extra links are valid. Not a mismatch.")

#         browser.close()

# # 🔧 Replace with your actual test URLs:
# live_url = "https://www.ups.com/ua/en/support/shipping-support/legal-terms-conditions.page"
# aem_url = "https://pt--ups-dev-pt--aemsites.aem.live/ua/en/support/shipping-support/legal-terms-conditions"

# compare_breadcrumbs(live_url, aem_url)
...
#     live_url = "https://www.ups.com/ua/en/support/shipping-support/legal-terms-conditions.page"
#     aem_url = "https://pt--ups-dev-pt--aemsites.aem.live/ua/en/support/shipping-support/legal-terms-conditions"
#     print(compare_breadcrumbs(live_url, aem_url))
